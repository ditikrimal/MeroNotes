 ...
 if(isset($_POST['sendBtn'])){
  ...
  $mail->Username='ctit22.dit@ismt.edu.np';
  $mail->Password='Capitan Roger@69';

  $mail->setFrom('email account', 'OTP Verification');
  $mail->addAddress($sesMail);
...
?>
          <html>
            <button type="submit" name="sendBtn">ClickMe</button>
          </html>
          <?php
          ?>
